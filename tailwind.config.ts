    ...
    extend: {
      ...
      keyframes: {
        ...
        'glow': { 
          ...
          '50%': { textShadow: '0 0 20px hsl(var(--primary)/0.5), 0 0 40px hsl(var(--primary)/0.3)' } 
        },
        'pulse-gentle': { 
          '0%, 100%': { opacity: '0.8' }, 
          '50%': { opacity: '1' } 
        ...
        'heartbeat': { 
          '0%': { transform: 'scale(1)' }, '10%': { transform: 'scale(1.1)' }, '20%': { transform: 'scale(1)' }, '100%': { transform: 'scale(1)' } 
        },
      },
      animation: {
