    ...
    <div className="flex-1 flex items-center justify-center p-4 sm:p-8">
       <Card className="w-full max-w-lg shadow-xl bg-card/70 backdrop-blur-lg border-2 border-primary/20 relative">
        <CardHeader className="items-center text-center">
          <Image src="https://storage.googleapis.com/project-spark-b2952.appspot.com/yuki-ai--yuki-ai/generated/7a274533-3d92-4914-b6c8-a92af35d3d44.png" data-ai-hint="beautiful woman" alt="Raven" width={100} height={100} className="rounded-full border-4 border-primary/50 shadow-lg" />
